...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $price = 14299.00; // Assuming the price of Mags is $14999.00
    ...
    if ($quantity > $availableQuantity) {
        ...
        $insertSql = "INSERT INTO products (price, qty, productName, MOP) VALUES ($totalPrice, $quantity, 'Rusi Royal', '$payment')";
