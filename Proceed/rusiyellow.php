...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $price = 14299.00; // Assuming the price of Mags is $1299.00
    ...
    if ($quantity > $availableQuantity) {
        ...
        $insertSql = "INSERT INTO products (price, qty, productName, MOP) VALUES ($totalPrice, $quantity, 'Rusi Passion', '$payment')";
...
<div class="navbar">
    ...
    <img src="../CRUD/Photo/rusiPassY.jpg"  alt="Error">
            <div class="col-desc">
                ...
                <p>Price: <span id="currentPrice">14,299.00</span></p> <br>
            </div>
